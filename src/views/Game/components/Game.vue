...
export default {
  ...
  methods: {
    download (data) {
      if(data == 'pc'){
        window.open('https://cdn.sealemlab.com/sacredrealm_app_release/SacredRealm_Main_1.0.6_PC.rar')
      }else{
        window.open('https://cdn.sealemlab.com/sacredrealm_app_release/SacredRealm_Main_1.0.6.apk')
      }
    },
  }
};
