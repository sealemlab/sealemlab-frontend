      ...
      <div class="otu_onebox">
        <div class="onebox">
          ...
          <div class="coin">
            ...
            <div class="btn">Approve/Stake</div>
          </div>
          <div class="coin">
            <div class="left">
...
.staking_box{
  ...
  .staking_box{
    ...
    .otu_onebox{
      ...
      padding: 2px;
      border-radius: 12px;
      background: linear-gradient(135deg, rgba(149, 127, 93, 0.19) 0%, rgba(226, 202, 169, 0.58) 46%, rgba(237, 213, 180, 0.13) 68%, rgba(131, 102, 77, 0.21) 100%);
      .onebox{
        width: 100%;
        height: 100%;
        border-radius: 12px;
        ...
        .out_top_box{
          ...
          border-radius: 5px;
          padding: 2px;
          background: linear-gradient(135deg, rgba(234, 206, 129, 0.16) 0%, #D4BA74 53%, rgba(188, 164, 101, 0.15) 100%);
          .top_box{
            width: 100%;
            height: 100%;
            background: linear-gradient(132deg, #0E0E0E 0%, #0B0A0A 100%);
