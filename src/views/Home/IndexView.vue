    ...
    <div class="characteristic_box make_money_people display_flex">
      ...
      <div class="show_peoplebox display_flex">
        ...
        <div class="right_maxpeople">
          ...
          <p class="add_title" :class="{ en_Regular: isEnLang }">格斗家</p>
          <p class="add_content" :class="{ en_Regular: isEnLang }">《圣域》是一款基于区块链技术的大型多人在线MORPG游戏，游戏采用虚幻4引擎打造，有着超精致的画面表现、动作性以及打击感。</p>
          <p class="add_content" :class="{ en_Regular: isEnLang }">圣域叙述光之英雄与黑暗力量之间的无尽战斗。玩家所扮演的光之英雄挺身而出，直到消灭黑暗之主为止，让久违的和平再度降临圣域！</p>
        </div>
      </div>
    </div>
    <!-- 游戏场景展示 -->
