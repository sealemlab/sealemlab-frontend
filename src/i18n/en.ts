export const message = {
  ...
  bond: {
    ...
    txt34:
      "After the bond expires, the principal and interest will be claimed in ST; the payment token system will automatically form an LP and lock into the treasury; the tax rate will be reset to the initial value of 1% every month as the purchase volume increases",
    txt35: "Total bond",
    txt36: "Extra rate",
    txt37: "Duration",
    txt38: "Countdown",
    ...
    txt75:
      "The invitee stake ST increasing by 1K USD, the interest rate increases by 0.1%,;cancel the staking by 1k USD, and the interest rate decreases by 1%",
