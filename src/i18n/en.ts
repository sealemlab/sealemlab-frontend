export const message = {
  ...
  bond: {
    ...
    txt75:"The invitee stake ST increasing by 1k, the interest rate increases by 0.1%,;cancel the staking by 1k, and the interest rate decreases by 1%",
