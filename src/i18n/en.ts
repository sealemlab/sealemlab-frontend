export const message = {
  ...
  nft: {
    ...
    txt30:
      "The Sacred Realm mystery box is a 3D digital asset of Unreal 4, in which each NFT corresponds to a unique piece of equipment in game, and its value can be measured in terms of levels, power, and rarity.",
  ...
  bond: {
    ...
    txt33: "Purchased",
    txt34:
      "After the bond expires, the principal and interest will be claimed in ST; the payment token system will automatically form an LP and lock into the treasury; the tax rate will be reset to the initial value of 0.1% every month as the purchase volume increases",
    txt35: "Total bond",
    txt36: "Extra rate",
    txt37: "Duration",
    txt38: "Countdown",
    ...
    txt51:
      "The Basic rate changes according to the total liquidity; each account enjoys a maximum of 30% additional interest rate; the staking interest rate changes according to the staked amount, and the level will be reduced if the staked balance is decreased. ",
    txt52: "Bond balance",
    txt53: "Claimable",
    txt54: "Claim all",
    txt55: "History",
    ...
    txt73: "The initial interest rate is 1%, and the interest rate increases by 0.1% for every 1k increase of liquidity.",
    txt74: "1k increase in bond purchase by invitees and 0.1% increase in interest rate",
    txt75:
      "The invitee stake ST increasing by 1k, the interest rate increases by 0.1%,;cancel the staking by 1k, and the interest rate decreases by 1%",
    txt76: "The staking increases by 1k, and the interest rate increases by 0.1%",
