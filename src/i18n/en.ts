export const message = {
  ...
  home: {
    ...
    txt54: "ROADMAP",
    txt55: "SealemLab was established and the core team was formed",
    txt56: "Research market and products",
    txt57: "Swap and bond research and development, model setting",
    txt58: "Gamefi Team Recruitment and Development",
    txt60:"Social media establishment, competitive product analysis and NFT market establishment",
    txt61:"Early Guild Recruitment,marketing",
    txt62:"Sealem and the official website of the first game 'Sacred Realm' are online.Included in CoinMarketCap / CoinGecko.Public sale, first token minting and Pancakeswap listing.Launch more DEX/CEX multilingual communities.NFT Genesis Blind Box Pre-sale.DAO governance open.The first game 'Sacred Realm' is online, IOS and Google stores are online.",
    txt63:"Swap is online and more CEXs are listed.Global Guild Recruitment.Game Updates New Game Release Voting.Dubai Offline Guild Competition.Dubai Gamefi roundtable held.",
    txt64:"Cross-chain plan sealem v2 released.The creator platform is online.more marketing.",
  ...
  bond:{
    ...
    txt2_1:"Bonds are controlled by Sealemdao, cooperate with top protocols and build a decentralized open financial platform",
